 ...
 */
package com.component.base.http.interceptor
    ...
    interface Logger {
        ...
        companion object {
            ...
            val DEFAULT: Logger = object : Logger {
                override fun log(message: String) = Platform.get().log(INFO, message, null)
            }
        }
    }
        ...
        if (logHeaders) {
            ...
            if (!logBody || !HttpHeaders.hasBody(response)) {
                ...
                if (contentLength != 0) {
                    ...
                    //添加测试
                    val urlMessage = "--> " + request.method() + ' ' + request.url() + ' ' + protocol
