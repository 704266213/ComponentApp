package com.component.base.http.retrofit

import com.component.base.BaseApplication
import com.component.base.http.interceptor.NativeCacheInterceptor
import com.component.base.http.interceptor.NetworkCacheInterceptor
...
class CacheRetrofit : BaseRetrofit() {
    ...
    init {
        val applicationContext = BaseApplication.getRootContext()
