...
import com.component.base.widget.progress.CircularProgressView
import com.component.base.widget.reflesh.PtrFrameLayout
import com.component.base.widget.reflesh.PtrUIHandler
...
class PtrHeader : FrameLayout, PtrUIHandler {
    ...
    fun init(context: Context) {
        ...
        val layoutFooterParams = LinearLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, resources.getDimension(R.dimen.dp_60).toInt())
        layoutParams = layoutFooterParams

        headPaddingTop = resources.getDimension(R.dimen.dp_10).toInt()
    }
