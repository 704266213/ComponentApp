package com.component.base.widget.progress;
...
public class CircularProgressView extends View {
    ...
    private int thickness, color, animDuration, animSwoopDuration, animSyncDuration, animSteps, ringColor;
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        currentProgress = a.getFloat(R.styleable.CircularProgressView_progress,
                resources.getInteger(R.integer.default_progress));
        maxProgress = a.getFloat(R.styleable.CircularProgressView_maxProgress,
                resources.getInteger(R.integer.default_max_progress));
        thickness = a.getDimensionPixelSize(R.styleable.CircularProgressView_thickness,
                resources.getDimensionPixelSize(R.dimen.default_thickness));
        isIndeterminate = a.getBoolean(R.styleable.CircularProgressView_indeterminate,
                resources.getBoolean(R.bool.default_is_indeterminate));
        autostartAnimation = a.getBoolean(R.styleable.CircularProgressView_animAutostart,
                resources.getBoolean(R.bool.default_anim_autostart));
        initialStartAngle = a.getFloat(R.styleable.CircularProgressView_startProgressAngle,
                resources.getInteger(R.integer.default_start_angle));
        startAngle = initialStartAngle;

        isShowRing = a.getBoolean(R.styleable.CircularProgressView_isShowRing, false);
        if (isShowRing) {
            ringColor = a.getColor(R.styleable.CircularProgressView_ringColor, resources.getColor(R.color.color_eaeaea));
        }
        ...
        if (a.hasValue(R.styleable.CircularProgressView_progressColor)) {
            color = a.getColor(R.styleable.CircularProgressView_progressColor, resources.getColor(R.color.default_color));
        }
        ...
        // If using native accentColor (SDK >21)
            ...
            color = t.getColor(0, resources.getColor(R.color.default_color));
        } else {
            //Use default color
            color = resources.getColor(R.color.default_color);
        }

        animDuration = a.getInteger(R.styleable.CircularProgressView_animDuration,
                resources.getInteger(R.integer.default_anim_duration));
        animSwoopDuration = a.getInteger(R.styleable.CircularProgressView_animSwoopDuration,
                resources.getInteger(R.integer.default_anim_swoop_duration));
        animSyncDuration = a.getInteger(R.styleable.CircularProgressView_animSyncDuration,
                resources.getInteger(R.integer.default_anim_sync_duration));
        animSteps = a.getInteger(R.styleable.CircularProgressView_animSteps,
                resources.getInteger(R.integer.default_anim_steps));
        a.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowRing) {
            canvas.drawArc(bounds, 0, 360, false, ringPaint);
        }
        // Draw the arc
