package com.component.base.widget
...
class LoadingFooterLayout : LinearLayout, OnLoadingViewListener {
    ...
    private fun initView(context: Context) {
        ...
        val layoutFooterParams = LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, resources.getDimension(R.dimen.dp_60).toInt())
